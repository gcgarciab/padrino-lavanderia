...
database_name = case Padrino.env
  when :development then 'lavanderia_development'
  when :production  then 'lavanderia_production'
  when :test        then 'lavanderia_test'
end
...
#     sessions:
#       default:
#         database: lavanderia_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: lavanderia_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: lavanderia_test
#         hosts:
#           - localhost:27017
#
#
